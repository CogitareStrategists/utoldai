  ...
  const sections = [
    {
      id: '01',
      eyebrow: 'Complexity',
      title: 'Hospitals operate in high-pressure environments',
      line: 'Decisions impact lives, not just efficiency',
      question: 'Where should AI assist and where should it stay away?',
      image:
    ...
    },
    {
      id: '02',
      eyebrow: 'Overload',
      title: 'Too many AI tools promise transformation',
      line: 'Few understand clinical workflows',
      question: 'Which solutions actually integrate into hospital reality?',
      image:
    ...
    },
    {
      id: '03',
      eyebrow: 'Trust',
      title: 'Doctors and staff rely on experience and precision',
      line: 'Adoption cannot be forced',
      question: 'How do you introduce AI without disrupting trust?',
      image:
    ...
    },
    {
      id: '04',
      eyebrow: 'Adoption',
      title: 'Technology fails when people resist it',
      line: 'Even in advanced hospitals, habits dominate',
      question: 'How do you ensure real usage across teams?',
      image:
    ...
    },
    {
      id: '05',
      eyebrow: 'Outcomes',
      title: 'AI in healthcare is not about experiments',
      line: 'It is about measurable outcomes and safety',
      question: 'How do you scale AI without risking care quality?',
      image:
        ...
        <div className="relative mx-auto mt-4 grid min-h-[calc(100vh-6.5rem)] max-w-7xl items-stretch gap-10 lg:grid-cols-12 lg:gap-0">
          ...
          >
            <img
              ...
              alt="Hospital AI consulting visual"
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mt-6 space-y-4 sm:space-y-5">
                <p className="text-xl text-white/72 sm:text-2xl lg:text-3xl">
                  Serious care needs serious decisions
                </p>
                <p className="text-xl text-white/72 sm:text-2xl lg:text-3xl">
                ...
                <h2 className="max-w-4xl text-3xl font-semibold leading-[0.96] tracking-[-0.055em] text-white sm:text-5xl lg:text-[4rem] [font-family:Inter_Tight,Inter,ui-sans-serif,system-ui,sans-serif]">
                  To work together on AI for hospitals
                </h2>
              </div>
            </div>
