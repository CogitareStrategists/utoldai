  ...
  const sections = [
    {
      id: '01',
      eyebrow: 'Risk',
      title: 'Finance runs on precision and risk',
      line: 'Small errors can scale into major consequences',
      question: 'Where can AI support without increasing risk exposure?',
      image:
    ...
    },
    {
      id: '02',
      eyebrow: 'Judgment',
      title: 'Automation is often mistaken for intelligence',
      line: 'Speed increases, but decisions may not improve',
      question: 'How do you ensure AI improves judgment, not just speed?',
      image:
    ...
    },
    {
      id: '03',
      eyebrow: 'Trust',
      title: 'Every system claims better predictions',
      line: 'But few explain their decisions clearly',
      question: 'Which AI systems can you truly trust in financial decisions?',
      image:
    ...
    },
    {
      id: '04',
      eyebrow: 'Adoption',
      title: 'Adoption in finance is cautious',
      line: 'People trust processes built over years',
      question: 'How do you introduce AI without breaking institutional trust?',
      image:
    ...
    },
    {
      id: '05',
      eyebrow: 'Control',
      title: 'Starting AI initiatives is easy',
      line: 'Scaling them responsibly is not',
      question: 'How do you scale AI while maintaining compliance and control?',
      image:
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#07111f] text-white [font-family:Inter,ui-sans-serif,system-ui,sans-serif]">
      ...
      <section className="relative min-h-screen px-5 pt-6 sm:px-8 lg:px-12">
        ...
        >
          <Link
            href="/"
            className="text-[11px] uppercase tracking-[0.42em] text-white/68 transition hover:text-white"
          >
            UTOLD AI
          </Link>
        ...
        <div className="relative mx-auto mt-4 grid min-h-[calc(100vh-6.5rem)] max-w-7xl items-stretch gap-10 lg:grid-cols-12 lg:gap-0">
          ...
          >
            <div className="max-w-3xl">
              ...
              <h1 className="max-w-4xl text-5xl font-semibold uppercase leading-[0.84] tracking-[-0.075em] text-white sm:text-6xl lg:text-[5rem] xl:text-[5.7rem] [font-family:Inter_Tight,Inter,ui-sans-serif,system-ui,sans-serif]">
                Plan AI for finance with discipline.
              </h1>
              <div className="mt-10 max-w-2xl space-y-4 text-lg leading-relaxed text-white/72 sm:text-xl lg:text-[1.55rem]">
                <p>Decisions carry weight</p>
                <p>Risk is always present</p>
                <p className="text-white">Precision is not optional</p>
              </div>
          ...
          >
            <img
              ...
              alt="Finance AI consulting visual"
                ...
                >
                  <div>
                    ...
                    <div className="mt-8 space-y-5 lg:space-y-6">
                      <h2 className="text-3xl font-semibold leading-[0.95] tracking-[-0.055em] text-white sm:text-4xl lg:text-[3.2rem] [font-family:Inter_Tight,Inter,ui-sans-serif,system-ui,sans-serif]">
                        {section.title}
                      </h2>
                      <p className="max-w-2xl text-lg leading-relaxed text-white/66 sm:text-xl lg:text-[1.35rem]">
                        {section.line}
                      </p>
                      <p className="pt-4 text-2xl font-medium leading-tight tracking-[-0.03em] text-cyan-50 sm:text-3xl lg:text-[2.35rem]">
                        {section.question}
                      </p>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mt-6 space-y-4 sm:space-y-5">
                <p className="text-xl text-white/72 sm:text-2xl lg:text-3xl">
                  Serious capital needs serious decisions
                </p>
                <p className="text-xl text-white/72 sm:text-2xl lg:text-3xl">
                  If you have the intent, we can help shape the path
                </p>
                <h2 className="max-w-4xl text-3xl font-semibold leading-[0.96] tracking-[-0.055em] text-white sm:text-5xl lg:text-[4rem] [font-family:Inter_Tight,Inter,ui-sans-serif,system-ui,sans-serif]">
                  To work together on AI for finance
                </h2>
              </div>
            </div>
