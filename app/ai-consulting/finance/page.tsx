        ...
        <div className="relative mx-auto mt-4 grid min-h-[calc(100vh-6.5rem)] max-w-7xl items-stretch gap-10 lg:grid-cols-12 lg:gap-0">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.85, delay: 0.1, ease: [0.22, 1, 0.36, 1] }} className="relative z-10 flex items-center py-10 lg:col-span-5 lg:py-20">
            <div className="max-w-3xl">
              ...
              <h1 className="max-w-4xl text-5xl font-semibold uppercase leading-[0.84] tracking-[-0.075em] text-white sm:text-6xl lg:text-[5rem] xl:text-[5.7rem] [font-family:Inter_Tight,Inter,ui-sans-serif,system-ui,sans-serif]">Plan AI for finance with discipline.</h1>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.985 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.95, delay: 0.15, ease: [0.22, 1, 0.36, 1] }} className="relative mt-2 min-h-[440px] overflow-hidden rounded-[2rem] lg:col-span-7 lg:mt-0 lg:min-h-full xl:rounded-[2.75rem]">
            <img src="https://images.unsplash.com/photo-1556740749-887f6717d7e4?auto=format&fit=crop&w=2000&q=80" alt="Finance AI consulting visual" className="absolute inset-0 h-full w-full scale-[1.03] object-cover" />
          ...
          <div className="grid gap-8 px-6 py-10 sm:px-8 sm:py-14 lg:grid-cols-12 lg:px-14 lg:py-16">
            <div className="lg:col-span-8">
              ...
              <div className="mt-6 space-y-4 sm:space-y-5">
                <p className="text-xl text-white/72 sm:text-2xl lg:text-3xl">Serious capital needs serious decisions</p>
                <p className="text-xl text-white/72 sm:text-2xl lg:text-3xl">If you have the intent, we can help shape the path</p>
                <h2 className="max-w-4xl text-3xl font-semibold leading-[0.96] tracking-[-0.055em] text-white sm:text-5xl lg:text-[4rem] [font-family:Inter_Tight,Inter,ui-sans-serif,system-ui,sans-serif]">To work together on AI for finance</h2>
              </div>
            </div>
